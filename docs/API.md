...
Below is a very barebones example of a handler definition, for a complete working example, check the [cluster demo](https://github.com/scshark/pitayas/tree/master/examples/demo/cluster).

```go
import (
  "github.com/topfreegames/pitaya"
  "github.com/scshark/pitayas/component"
)
...
For a complete working example, check the [cluster demo](https://github.com/scshark/pitayas/tree/master/examples/demo/cluster).
